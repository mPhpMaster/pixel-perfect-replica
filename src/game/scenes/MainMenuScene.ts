...
import {getDefaultMeta, loadMeta, saveMeta, STORAGE_KEY} from '../systems/MetaProgression';
...
export class MainMenuScene extends Phaser.Scene {
    ...
    private showMenu(): void {
        ...
        // Shop button
        this.createButton(width / 2, height * 0.62, 'SHOP', () => {
        ...
        // Coin display
            const coinText = this.add.text(width / 2, height * 0.82, `COINS: ${meta.coins}💰`, {
            fontFamily: '"Press Start 2P"',
            fontSize: '14px',
            color: '#ffdd00',
        });
        ...
        const highScoreText = this.add.text(width / 2, height * 0.87, `HIGH SCORE: ${highScore}`, {
            fontFamily: '"Press Start 2P"',
            fontSize: '12px',
            color: '#ffaa00',
        });
        ...
        // Kills display
        const kills = loadMeta().totalKills;
        const killsText = this.add.text(width / 2, height * 0.89, `KILLS: ${kills}`, {
            fontFamily: '"Press Start 2P"',
            fontSize: '8px',
            color: '#c57805',
        });
        ...
        // Controls hint
        const controlsText = this.add.text(width / 2, height * 0.96, 'WASD or ARROWS to move, SPACE to dash', {
            fontFamily: 'Inter',
            fontSize: '12px',
            color: '#666688',
        });
